---
title: "M. coronaria population genetic study EU, ASIA & US (CABI submission)"
author: "Lukas Wille"
...
### Allelic frequencies and PIC (polymorphic information content)
...
#### MLG accumulation curves --> for Supp. Fig. 1 in the manuscript
...
# pop all
gac_all <- genotype_curve(MCpop_all, sample = 1000, quiet = TRUE, thresh = NULL)  # do not print a hline at the max. no. of MLG possible
rareP_all <- last_plot() +
...
# pop EU
gac_EU <- genotype_curve(MCpop_EU, sample = 1000, quiet = TRUE, thresh = NULL)
rareP_EU <- last_plot() +
...
#### Multi-locus genotypes - MLGs --> for Fig 2. in the manuscript
...
#### Minimum spanning network (Bruvo's distance) with MLGs
